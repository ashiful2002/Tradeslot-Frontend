...
import { Calendar, CreditCard, LayoutDashboard, LogOut, ShieldCheck, User, Wrench } from 'lucide-react';
    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-slate-900/80 border-b border-slate-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 font-bold text-xl tracking-tight text-emerald-400">
          ...
          <span>Trade<span className="text-white">Slot</span></span>
          ...
          {currentUser ? (
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-slate-800">
              <button
                onClick={async () => {
                  // Demo Trader Login
                  await authService.login('trader@tradeslot.com', 'password123');
