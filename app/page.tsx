    ...
    <div className="relative min-h-screen pb-20">
      ...
      <section className="pt-16 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center space-y-6">
        ...
        <p className="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">
          Intelligent schedule optimization with 30-minute travel buffers,
          instant WhatsApp/Web chatbot intake, and automated Stripe Connect
          payouts.
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 pt-2 text-xs">
          {["ALL", "Plumbing", "Electrical", "Heating", "Carpentry"].map(
            (cat) => (
              <button
                key={cat}
